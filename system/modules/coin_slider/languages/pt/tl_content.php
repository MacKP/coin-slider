...
$GLOBALS['TL_LANG']['tl_content']['select_coinSlider']['1'] = "Queiram selecionar um diaporama";

$GLOBALS['TL_LANG']['tl_content']['select_coinSlider_legend'] = 'Seleção do diaporama';
?>
