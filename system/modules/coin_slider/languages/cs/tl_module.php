...
$GLOBALS['TL_LANG']['tl_module']['select_coinSlider']['1'] = "Vyberte slideshow (prezentaci obrázků)";

$GLOBALS['TL_LANG']['tl_module']['select_coinSlider_legend'] = 'Vyberte slideshow';
?>
